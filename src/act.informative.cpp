...
"  ^Wcrapsell [max_value]^n: At a shopkeeper, sell inventory items with value <= threshold.\r\n"
"  ^Wmassfix [cash|credstick]^n: At a fixer, queue repairs for all damaged gear.\r\n"
"\r\n"
"Notes:\r\n"
